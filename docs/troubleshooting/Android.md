...
| Tablet/pad (`smallestScreenWidthDp >= 600`) | Portrait dan landscape dengan hierarchy mobile yang sama, dialogs, writing canvas, practice flows, process recreation |
