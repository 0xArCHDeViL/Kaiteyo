...
code = """package ua.syt0r.kanji.presentation.screen.main.screen.practice_grammar.use_case
...
"""
with open("core/src/commonMain/kotlin/ua/syt0r/kanji/presentation/screen/main/screen/practice_grammar/use_case/GetGrammarPracticeConjugationDataUseCase.kt", "w", encoding="utf-8") as f:
    f.write(code)
